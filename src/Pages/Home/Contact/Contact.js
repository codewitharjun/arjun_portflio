...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('gmail', 'my_portfolio', form.current, 'user_PpinHhUjmq8afuhtSTjPc')
      .then((result) => {
        alert('Thank yor for your message');
      }, (error) => {
    ...
    <Container id="contact">
      ...
      <Row xs={1} md={2} lg={2} className="w-100">
          <Col md="5" lg="5" className="bg-gray text-start g-2">
            ...
            <h4 className="fw-bold text-info my-4"><i className="fas fa-envelope"></i> arjunroy.arjun2@gmail.com</h4>
            ...
            <div className="d-flex justify-content-center mt-5">
              <div className="fs-2">
              <a className="m-2" href="https://www.facebook.com/arjunroy4" >
              <i className="fab fa-facebook"></i>
              </a>
              <a className="m-2" href="https://github.com/codewitharjun" >
                <i className="fab fa-github"></i>
              </a>
              <a className="m-2" href="https://www.linkedin.com/in/arjun-roy2/" >
